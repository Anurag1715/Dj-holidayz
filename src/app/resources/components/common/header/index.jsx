    ...
    useEffect(() => {
        ...
        const resizeObserver = new ResizeObserver(() => {
            if (headerRef.current) {
                ...
                document.documentElement.style.setProperty('--header-space-height', `${height}px`);
            }
        });
                ...
                <div className={styles.dj_header_wrapper}>
                    <div className={styles.dj_header_left}>
                        ...
                        <div className={styles.link_wrapper}>
                            {useMemo(() => (
                                HEADER_LINKS.slice(0, showMore ? HEADER_LINKS.length : 11).map((item) => {
                                    ...
                                    const formattedTitle =
                                        words.length > 1 ? (
                                            <>
                                                ...
                                                <span className={styles.second_word}>{words.slice(1).join(' ')}</span>
                                            </>
                                        ) : (
                                            item.title
                                        );
                                    ...
                                    return (
                                        <div key={item.id} className={styles.dj_header_linkWrapper}>
                                            <Link
                                                href={item.path}
