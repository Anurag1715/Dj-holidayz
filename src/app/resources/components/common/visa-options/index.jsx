      ...
      <div className="contain">
        <div className={styles.dj_content_wrapper}>
          <div className={styles.dj_top_section}>
            ...
            <p className={styles.dj_subtitle}>Choose the best visa category for your travel needs.</p>
          </div>
        </div>
            ...
            <div key={idx} className={styles.card}>
              ...
              <div className={styles.cardBody}>
                <div className={styles.infoRow}>
                  ...
                  <span className={`${styles.value} ${styles.badge}`}>{option.category}</span>
                </div>
                <div className={styles.infoRow}>
              ...
              <div className={styles.pricingSection}>
                <div className={styles.priceBlock}>
                  ...
                  <span className={styles.priceValue}>{option.visaFormFee}</span>
                </div>
                <div className={styles.priceBlock}>
