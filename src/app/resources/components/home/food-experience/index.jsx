        ...
        <div className={styles.simple_container}>
          ...
          <div className={styles.image_top}>
            ...
            <div className={styles.text_side}>
              <div
                className={styles.dj_top_section}
                style={{
              ...
              >
                <p className={styles.dj_tagline} style={{ margin: 0 }}>
                  Order Food Online
                </p>
              </div>
              <p className={styles.description}>
                At DJ Holidays, we believe great travel is defined by great
                food. Whether you are staying in a luxury hotel or a cozy
                apartment, you can explore local culinary delights with ease.
                <br />
                <br />
                Craving a cozy night in? You can now order your favorite meals
                from authorized delivery apps and themed restaurants. Enjoy a
                premium dining experience delivered straight to your door.
                <br />
                <br />
                <strong>Note:</strong> We recommend using the following
                platforms for the most reliable service during your stay.
              </p>
            </div>
          </div>
          ...
          <div className={styles.food_tour_section}>
            <div className={styles.dj_top_section}>
              ...
              <p className={styles.dj_subtitle}>
                Explore the diverse cuisines of our featured destinations.
              </p>
            </div>
