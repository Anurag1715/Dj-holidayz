...
const DIFFERENCES = [
  {
    ...
    description:
      "Our team’s deep travel roots bring you authentic experiences, cultural insights, and hidden gems worth discovering.",
  },
  {
    icon: <RocketIcon />,
    title: "Fast Processing",
    description:
      "We ensure a seamless and quick visa process, delivering a hassle-free journey filled with memories you’ll cherish.",
  },
  {
    icon: <PlaneIcon />,
    title: "Luxury & Comfort",
    description:
      "We collaborate with top hotels and trusted transport providers, ensuring every journey is comfortable and enjoyable.",
  },
  {
    icon: <KeyIcon />,
    title: "Exclusive Access",
    description:
      "Gain exclusive access to rare attractions and experiences, offering moments unavailable to the general public.",
  },
];
        ...
        <div className={styles.dj_content_wrapper}>
          <div className={styles.dj_top_section}>
            ...
            <p className={styles.dj_subtitle}>
              Discover unmatched journeys crafted with care and expertise.
            </p>
          </div>
