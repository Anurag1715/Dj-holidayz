...
/** Local imports */
import videoData from "@/Datastream/country/videos.json";
          ...
          <div className={styles.dj_bottom_content_wrapper}>
            <div className={styles.dj_tagline}>
              <p className={styles.dj_title}>
                Uncover The True Spirit and Timeless Soul of{" "}
                <span> Your Journey.</span>
              </p>
              <p className={styles.dj_subtitle}>
                From breathtaking landscapes to luxury stays,
                <span> DJ HOLIDAYS </span> crafts your unforgettable escape.
              </p>
            </div>
          ...
          <div className={styles.scrollContent}>
            {SCROLLING_FACTS.map((fact, index) => (
              <React.Fragment key={index}>
                ...
                {index < SCROLLING_FACTS.length - 1 && (
