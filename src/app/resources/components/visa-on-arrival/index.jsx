                ...
                <div className="contain">
                    <div className={styles.heroInner}>
                        <div className={styles.heroCopy}>
                            <span className={styles.eyebrow}>Travel freely. Get your visa when you arrive.</span>
                            <h1>Visa on Arrival for Indian Passport Holders</h1>
                            <p>
                                Travel easily with visa on arrival. Get your visa at the destination without prior
                                applications.
                            </p>
                        ...
                        <div className={styles.heroPanel}>
                            <div className={styles.statCard}>
                                ...
                                <p>
                                    Complete the visa process at the airport or entry point with basic documents and a
                                    short approval flow.
                                </p>
                            </div>
                ...
                <div className="contain">
                    <div className={styles.introInner}>
                        ...
                        <div className={styles.introBody}>
                            <p>
                                Visa on Arrival (VOA) allows Indian passport holders to obtain a visa upon reaching
                                their destination. There is no need to apply in advance, making it a convenient option
                                for spontaneous travel.
                            </p>
                            <p>
                                Upon arrival at the airport or designated entry point, travelers can complete a simple
                                process that may include filling out a form, providing documents, and paying a visa
                                fee. Entry is usually granted for short-term tourism or business purposes.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="contain">
                    <div className={styles.processInner}>
                        ...
                        <div className={styles.processBody}>
                            <p>
                                Travelers can directly fly to their destination without applying for a visa beforehand.
                                Upon arrival, they need to visit the visa counter at the airport or border entry point.
                            </p>
                            <p>
                                The process typically includes submitting a passport, filling out a short form,
                                providing photographs if required, and paying the visa fee. Once approved, the visa is
                                issued on the spot, allowing entry into the country.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="contain">
                    <div className={styles.ctaInner}>
                        <div className={styles.ctaCopy}>
                            ...
                            <p>
                                Discover more destinations with flexible visa options and start your journey with
                                ease.
                            </p>
                        </div>
