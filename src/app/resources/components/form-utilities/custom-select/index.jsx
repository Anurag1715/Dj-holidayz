  ...
  return (
    <Controller
      ...
      render={({ field, fieldState: { error } }) => (
        <div
          className={`${styles.te_input_select} ${error ? styles.error : ""}`}
        >
          {/* ✅ Static normal label */}
          {label && (
            <label className={styles.FormLabel}>{FieldName?.label}</label>
          )}
                    ...
                    {filterData(data, Search).length ? (
                      filterData(data, Search).map((item, i) => {
                        ...
                        return (
                          <li
                            key={i}
                            className={active ? styles.te_active : ""}
                          >
                            <button
                              type="button"
                              onClick={() => {
                            ...
                            >
                              <span className={styles.te_text}>
                                {item.label}
                              </span>
                              {active &&
                                (!multi ? (
                                  <CircleIcon className={styles.te_icon} />
                                ) : (
                                  <FillCheck className={styles.te_icon} />
                                ))}
                            </button>
                          </li>
                        );
