...
export const getNationalityOptions = () => {
    const commonNationalities = [
        'Indian', 'Emirati', 'Saudi', 'Omani', 'Qatari', 'Bahraini', 'Kuwaiti',
        'American', 'British', 'Canadian', 'Australian', 'German', 'French',
        'Italian', 'Spanish', 'Russian', 'Chinese', 'Japanese', 'South Korean',
        'Pakistani', 'Bangladeshi', 'Sri Lankan', 'Nepalese', 'Egyptian', 'Filipino',
        'Indonesian', 'Malaysian', 'Singaporean', 'Turkish', 'Vietnamese', 'Thai'
    ];
